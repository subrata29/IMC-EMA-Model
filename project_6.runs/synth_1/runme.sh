...
HD_PWD='C:/Users/Administrator/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CM1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CM1.tcl
