...
HD_PWD='C:/Users/Administrator/project_6/project_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CM1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CM1.tcl -notrace
